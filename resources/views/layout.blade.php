                ...
                <div class="navigation">
                    <div class="wrapper">
                        <ul class="navigation__menu">
                            <li>
                                <a href="/dashboard" {!! (Request::path() == 'dashboard') ? 'class="active"' : '' !!}><img class="active" src="/storage/logo_header_trans.png" style="height: 60px;"> <i class="far fa-home fa-sm color-blue"></i> <span class="hidden ml-05">{{ __('general.dashboard') }}</span></a>
                            </li>
                            <li>
            ...
            @else
                <div class="navigation">
                    <div class="wrapper">
                        <ul class="navigation__menu">
                            <li>
                                <a href="/" {!! (Request::path() == 'dashboard') ? 'class="active"' : '' !!}><img class="active" src="/storage/logo_header_trans.png" style="height: 60px;"> <i class="far fa-home fa-sm color-blue"></i><span class="hidden ml-05">{{ env('APP_NAME') }}</span></a>
                            </li>
                            <li>
